...
const EditPlan = () => {
  ...
  const deletePlan = async () => {
    ...
    const response = await axios.delete(
      `http://localhost:8080/api/v1/user/plans/${planId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  return (
    <div>
    <Navbar />
    <div className="bg-cover bg-center h-screen bg-white" style={{
      backgroundImage: "url('https://img.freepik.com/free-vector/wave-with-shadow-abstract-blue-lines-background_1142-8462.jpg?t=st=1710085142~exp=1710088742~hmac=419bead2210e41ede07846386c6a843f633e293be64707581940811149c97b7d&w=1060')",
